    <div class="modal fade" id="adminSetLikesModal" tabindex="-1" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content bg-dark text-white">
                <div class="modal-header">
                    <h5 class="modal-title">Set Likes for Post</h5>
                    <button type="button" class="btn-close btn-close-white" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                <div class="modal-body">
                    <label class="form-label">Current Likes: <span id="currentLikesDisplay">0</span></label>
                    <input type="number" id="adminLikesInput" class="form-control bg-secondary text-white" min="0" value="0" required>
                </div>
                <div class="modal-footer">
                    <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Cancel</button>
                    <button type="button" class="btn btn-primary" id="saveAdminLikesBtn">Save</button>
                </div>
            </div>
        </div>
    </div>
