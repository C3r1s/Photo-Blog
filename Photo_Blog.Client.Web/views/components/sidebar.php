    ...
    <div class="p-3">
        ...
        <ul class="nav flex-column">
            <li class="nav-item mb-2">
                <a href="/index.php" class="nav-link text-white d-flex align-items-center <?= $currentPage === 'home' ? 'active' : '' ?>">
            ...
            <li class="nav-item mb-2">
                <a href="/profile.php" class="nav-link text-white d-flex align-items-center <?= $currentPage === 'profile' ? 'active' : '' ?>">
                    <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" fill="currentColor" class="me-2" viewBox="0 0 16 16">
                        <path d="M8 15A7 7 0 118 1a7 7 0 010 14zm0-1.5a.5.5 0 00.5-.5V11a.5.5 0 00-.5-.5H6.5a.5.5 0 00-.5.5v2.5a.5.5 0 00.5.5H8z"/>
                    </svg>
                    Profile
